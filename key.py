...
model.add(Conv2D(32, kernel_size = 4, activation='relu', strides=(2,2), input_shape=(1,256,256), data_format='channels_first'))
...
model.fit(data, label, batch_size=10, nb_epoch=200, shuffle=True, verbose=1, validation_split=0.2)
