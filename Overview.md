...
In this section, some basic steps in facial expression recognition would be introduced, more specific content can be found in later chapters.
...
When faces are located successfully, these facial images can be extracted the facial transformation information generated by expressions. 

*As has been discussed above, feature-based orientation is a more popular direction in facial expression analysis field. Actually feature-based orientation can be primarily distinguished into two types of approaches*
